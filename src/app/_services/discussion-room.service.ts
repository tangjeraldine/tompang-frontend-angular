...
export class DiscussionRoomService {
  ...
  getMessages(page:any, discussionRmId:string) {
    ...
    return this.http.get(this.baseHref + "/customer/discussion-message/list?" + this._authService.generateAuthParamsStr(),
                         {params: params});
  }
  ...
  sendMessage(msg:string, discussionRmId:string) {
    ...
    return this.http.get(this.baseHref + "/customer/discussion-message/add?" + 
          this._authService.generateAuthParamsStr() + "&" + params_str);
  }
  ...
  sendFileMessage(file:File, discussionRmId:string) {
    ...
    return this.http.post(this.baseHref + "/customer/discussion-message/add-file", form_data);
  }
}
