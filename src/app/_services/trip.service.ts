...
export class TripService { 
  ...
  getTrips() {
    return this.http.get(this.baseHref + "/customer/trip/list?" + this._authService.generateAuthParamsStr());
  }

  updateTrip(id:string, from_postal:string, 
    to_postal:string, description:string, role:string, days:string, time_of_day:string) {
