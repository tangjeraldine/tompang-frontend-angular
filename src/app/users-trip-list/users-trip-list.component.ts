...
export class UsersTripListComponent {
  ...
  update() {
    ...
    this._tripService
      .updateTrip(
        this.trip_list[this.edit_row_index].id,
      ...
      .subscribe(
        (data: any) => {
          this.trip_list[this.edit_row_index].fromPostal =
            this.edit_from_postal;
          this.trip_list[this.edit_row_index].toPostal = this.edit_to_postal;
          this.trip_list[this.edit_row_index].description =
            this.edit_description;
  ...
  closeNotDeletedButton() {
    this.tripNotDeleted = false;
  }
